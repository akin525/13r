...
<div class="header-section header-transparent header-sticky">
    <div class="container position-relative">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-2 col-xl-3 col-7">
                <!-- Header Meta Start -->
                <div class="header-meta">
                    <ul class="header-meta__action d-flex justify-content-end">
                        <li><button class="action search-open"><i class="lastudioicon-zoom-1"></i></button></li>
            ...
            <li>
                <div class="hotline">
                    ...
                    <div class="hotline-content">
                        ...
                        <a class="hotline-link" href="tel:08100000">0810000</a>
                    </div>
                </div>
            </li>
            <li>
            ...
            <div class="row gy-6">
                <div class="text-center">
                    ...
                    <div class="footer-widget">
                        <div class="">
                            <a href="/"><img width="50" src="{{asset('13.jpeg')}}" alt="Logo"></a>
                        </div>
                        <div class="">
    ...
    <div class="footer-copyright">
        <div class="container">
            ...
            <div class="footer-copyright-text text-center">
                <p>&copy; 2024 <strong> All right reserved </strong> <i class="lastudioicon-heart-1"></i> by <a href="#">1303</a></p>
            </div>
